...
const derivedData = Object.keys(data).map((topLevelKey) => {
  ...
  const derivedObject = {
    ...
    householdIncome_100k_to_125k_pct: geoObject["277"].C1_COUNT_TOTAL / geoObject["260"].C1_COUNT_TOTAL,
    householdIncome_125k_to_150k_pct: geoObject["278"].C1_COUNT_TOTAL / geoObject["260"].C1_COUNT_TOTAL,
    householdIncome_150k_to_200k_pct: geoObject["279"].C1_COUNT_TOTAL / geoObject["260"].C1_COUNT_TOTAL,
    ...
    mostCommonSpokenLanguage_english_pct: geoObject["738"].C1_COUNT_TOTAL / geoObject["735"].C1_COUNT_TOTAL,
    ...
    householdIncome_100k_to_125k: geoObject["277"].C1_COUNT_TOTAL,
    householdIncome_125k_to_150k: geoObject["278"].C1_COUNT_TOTAL,
    householdIncome_150k_to_200k: geoObject["279"].C1_COUNT_TOTAL,
    motherTongue_english: geoObject["396"].C1_COUNT_TOTAL,
    mostCommonSpokenLanguage_english: geoObject["738"].C1_COUNT_TOTAL,
